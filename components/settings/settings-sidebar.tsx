...
import { Settings, User, Wallet, Bell, Lock, Download } from 'lucide-react';
...
export function SettingsSidebar() {
    ...
    const items = [
        ...
        { href: '/settings/wallets', label: 'My Wallets', icon: Wallet },
        ...
        <aside className="w-full lg:w-72 shrink-0 flex flex-col gap-6">
            ...
            <nav className="flex flex-col gap-1">
                ...
                {items.map((item) => (
                    ...
                    >
                        <item.icon className={`size-5 ${pathname === item.href ? 'fill-current' : ''}`} />
